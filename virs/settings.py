"""
Django settings for virs project.
...
SECRET_KEY = '7&1c01)94t4mv#%=j3$nz=huesa9slb$o1u%#kfgcedd&otxyk'
...
INSTALLED_APPS = [
    ...
    'cop',      # collection processing
    'vsm',      # vector space model application
]
...
WSGI_APPLICATION = 'virs.wsgi.application'
